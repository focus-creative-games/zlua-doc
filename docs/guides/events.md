...
规范见 [类型系统](/docs/spec/02-TYPE-SYSTEM/)、[成员绑定](/docs/spec/metatable/03-BINDING/)。
...
`handler` 为 Lua `function`，按 [回调与 Delegate](/docs/guides/callbacks-and-delegates/) 隐式 marshal。
...
| | |
|---|---|
| **上一篇** | [Lua 模块加载](/docs/guides/lua-module-loading/) |
| **下一篇** | [enum 与 struct](/docs/guides/enums-and-structs/) |

## 相关文档

- [回调与 Delegate](/docs/guides/callbacks-and-delegates/)
- [成员绑定规范](/docs/spec/metatable/03-BINDING/)
