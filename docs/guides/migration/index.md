...
| 文件 | 来源方案 | 内容 |
|------|----------|------|
| [from-xlua.md](/docs/guides/migration/from-xlua/) | xLua | `CS.*` → `CSharp`、Generate 废弃、`GetFunction` |
| [from-tolua.md](/docs/guides/migration/from-tolua/) | toLua / tolua# | 删除 Wrap、全局类 → 懒绑定 |
| [from-slua.md](/docs/guides/migration/from-slua/) | SLua | 导出配置 → public + 懒 Bind |
