...
<span className="runtimeBadge"><span className="runtimeBadgeMono">Mono · 已完成</span><span className="runtimeBadgeIl2cpp">Il2Cpp · 已完成</span></span> — 本页示例在 **Editor** 与 **Player** 均可用；Player 构建须 **Generate**，见 [兼容性](./compatibility)。
...
- 已完成 [安装与集成](./installation)（含 Settings + Install），或已 clone zlua-demo
- 任意 [兼容性](./compatibility) 所列 Unity 版本，Editor 下 Play 即可
...
详见 [项目状态](./project-status)、[Editor 与 Player](../guides/editor-vs-player)。
